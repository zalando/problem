...
final class ProblemMixInTest {
    ...
    void shouldSerializeProblemCause() {
        final Problem problem = Problem.builder()
            ...
            .withCause(
                Problem.builder()
                    .withType(
                        URI.create("https://example.org/expired-credit-card")
                    )
        ...
        with(json)
            .assertThat(
                "$.cause.type",
                is("https://example.org/expired-credit-card")
            )
            .assertThat("$.cause.title", is("Expired Credit Card"))
            .assertThat("$.cause.status", is(400))
            .assertThat(
                "$.cause.detail",
                is("Credit card is expired as of 2015-09-16T00:00:00Z")
            )
    ...
    void shouldDeserializeDefaultProblem() throws IOException {
        ...
        final Problem raw = mapper.readValue(
            resource.openStream(),
            Problem.class
        );
        ...
        assertThat(
            ...
            hasFeature(
                "type",
                Problem::getType,
                hasToString("https://example.org/not-out-of-stock")
            )
        );
        assertThat(
            problem,
            hasFeature("title", Problem::getTitle, equalTo("Out of Stock"))
        );
        assertThat(
            problem,
            hasFeature("status", Problem::getStatus, equalTo(BAD_REQUEST))
        );
        assertThat(
            problem,
            hasFeature(
        ...
        assertThat(
            ...
            hasFeature(
                "parameters",
                DefaultProblem::getParameters,
                hasEntry("product", "B00027Y5QG")
            )
        );
    }
    ...
    void shouldDeserializeRegisteredExceptional() throws IOException {
        ...
        final Exceptional exceptional = mapper.readValue(
            resource.openStream(),
            Exceptional.class
        );
        ...
        assertThat(
            ...
            hasFeature(
                "type",
                Problem::getType,
                hasToString("https://example.org/out-of-stock")
            )
        );
        assertThat(
            problem,
    ...
    void shouldDeserializeSpecificProblem() throws IOException {
        ...
        final InsufficientFundsProblem problem =
            (InsufficientFundsProblem) mapper.readValue(
                resource.openStream(),
                Problem.class
            );
        ...
        assertThat(
            ...
            hasFeature(
                "balance",
                InsufficientFundsProblem::getBalance,
                equalTo(10)
            )
        );
        assertThat(
            ...
            hasFeature(
                "debit",
                InsufficientFundsProblem::getDebit,
                equalTo(-20)
            )
        );
    }
    ...
    void shouldDeserializeUnknownStatus() throws IOException {
        ...
        final Problem problem = mapper.readValue(
            resource.openStream(),
            Problem.class
        );
        ...
        assertThat(
            status,
            hasFeature("status code", StatusType::getStatusCode, equalTo(666))
        );
        assertThat(
            status,
            hasFeature(
    ...
    void shouldDeserializeUntyped() throws IOException {
        ...
        assertThat(
            problem.getStatus(),
            hasFeature(StatusType::getStatusCode, is(400))
        );
    ...
    void shouldDeserializeCause() throws IOException {
        ...
        final ThrowableProblem problem = mapper.readValue(
            resource.openStream(),
            ThrowableProblem.class
        );

        assertThat(
            problem,
            hasFeature("cause", Throwable::getCause, is(notNullValue()))
        );
        ...
        assertThat(
            ...
            hasFeature(
                "type",
                Problem::getType,
                hasToString("https://example.org/expired-credit-card")
            )
        );
        assertThat(
            cause,
        ...
        assertThat(
            ...
            hasFeature(
                ...
                hasEntry("since", "2015-09-16T00:00:00Z")
            )
        );
    }
    ...
    void shouldDeserializeWithProcessedStackTrace() throws IOException {
        ...
        // In Jackson 3, the deserialization mechanism has changed and generates different stack traces
        // We just verify that a valid stack trace exists with at least 2 elements
        assertThat(
            stackTraceElements.length,
            is(org.hamcrest.Matchers.greaterThan(1))
        );
        assertThat(stackTraceElements[1], startsWith("\tat "));
    }
